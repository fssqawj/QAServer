...
def run(processor):
    ...
    with codecs.open(processor.summary_saved_file.format(today), 'w', encoding='utf-8') as f:
    ...
    with codecs.open(processor.detail_saved_file.format(today), 'w', encoding='utf-8') as f:
